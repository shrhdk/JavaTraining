...
public class LinkedListTest {
	...
	@Test
	public void objectFound() throws ObjectNotFoundException {
		Object o1 = new Object();
		Object o2 = new Object();
		Object o3 = new Object();
		Object o4 = new Object();
		Object o5 = new Object();
		LinkedList<Object> list = new LinkedList<Object>(o1, o2, o3, o4, o5);

		assertSame(list.find(o1).value, o1);
		assertSame(list.find(o2).value, o2);
		assertSame(list.find(o3).value, o3);
		assertSame(list.find(o4).value, o4);
		assertSame(list.find(o5).value, o5);
	}

	@Test(expected = ObjectNotFoundException.class)
	public void objectNotFound() throws ObjectNotFoundException {
		Object o1 = new Object();
		Object o2 = new Object();
		Object o3 = new Object();
		Object o4 = new Object();
		...
		list.find(new Object());
	}

	@Test
	public void findNull() throws ObjectNotFoundException {
		Object o1 = new Object();
		Object o2 = new Object();
		Object o3 = null;
		Object o4 = new Object();
	...
	public void testDelete() {
		LinkedList<String> list = new LinkedList<String>("hoge", "fuga",
				"piyo", "watagashi");
	...
	public void testClone() {
		StringBuffer[] values = new StringBuffer[] { new StringBuffer("hoge"),
				new StringBuffer("fuga"), new StringBuffer("piyo"),
				new StringBuffer("watagashi") };
