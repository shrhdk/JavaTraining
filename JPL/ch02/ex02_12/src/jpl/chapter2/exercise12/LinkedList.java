...
public class LinkedList {
	...
	System.out.println("LinkedListクラスでは、可変長メソッドではありませんが、オブジェクトの配列からオブジェクトのリストが作れる可変長コンストラクタがあれば便利です。");
	System.out.println("(実行例) new LinkedList(\"A\", \"B\", \"C\", \"D\").toString(): " + new LinkedList("A", "B", "C", "D").toString());
    }
