...
public class LinkedListTest {
	...
	public void testGetLength() {
		...
		assertEquals(4, linkedList1.getLength());
		assertEquals(3, linkedList2.getLength());
		assertEquals(2, linkedList3.getLength());
		assertEquals(1, linkedList4.getLength());
	}
	...
	public void testLinkedListWithObjectArray() {
		...
		LinkedList linkedList = new LinkedList(object1, object2, object3,
				object4);
